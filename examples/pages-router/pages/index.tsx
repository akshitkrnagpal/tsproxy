...
/**
 * Relative serverUrl works because `createSearchClient` runs in the
 * browser on the same origin as this Next.js host. The Pages Router
 * catch-all at `pages/api/tsproxy/[[...path]].ts` picks up every
 * request.
 */
    ...
    <SearchProvider serverUrl={SERVER_URL} indexName={INDEX_NAME}>
      <div className="app-shell">
        <div className="header">
          ...
          <div className="badge">Pages Router · embedded tsproxy</div>
          <div style={{ flex: 1 }}>
            <SearchBox
